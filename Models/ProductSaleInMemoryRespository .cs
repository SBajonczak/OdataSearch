    ...
    public class ProductSaleInMemoryRespository : IProductSaleRepository
    {
        ...
        static ProductSaleInMemoryRespository()
        {
            ...
            _products = new List<Product>()
            {
                new Product
                {
                    Id = 1, Name = "Bread", Color = Color.White, Price = 6.5, Qty = 10,  TaxRate = 0.10,
                ...
                new Product
                {
                    Id = 2, Name = "Pencil", Color = Color.Blue, Price = 3.99, Qty = 15,  TaxRate = 0.14,
                ...
                new Product
                {
                    Id = 3, Name = "Noodle", Color = Color.Brown, Price = 2.99, Qty = 50,  TaxRate = 0.10,
                ...
                new Product
                {
                    Id = 4, Name = "Flute", Color = Color.Yellow, Price = 12.0, Qty = 75,  TaxRate = 0.14 ,
                    Location = addresses[0],
                    Sales = new List<Sale>
                    {
                ...
                new Product
                {
                    Id = 5, Name = "Paper", Color = Color.White, Price = 6.99, Qty = 14 ,  TaxRate = 0.24,
                    Location = addresses[2],
                    Sales = new List<Sale>
                    {
                ...
                new Product
                {
                    Id = 6, Name = "Violin", Color = Color.Blue, Price = 125.00, Qty = 15, TaxRate = 0.44,
                    Location = addresses[1],
                     Sales = new List<Sale>
                    {
